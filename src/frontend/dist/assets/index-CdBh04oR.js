...
function CinematicIntro({ onComplete }) {
  ...
  const [phase, setPhase] = reactExports.useState("ride");
  const [canvasOpacity, setCanvasOpacity] = reactExports.useState(1);
  const [charminarOpacity, setCharminarOpacity] = reactExports.useState(0);
  const [charminarScale, setCharminarScale] = reactExports.useState(1);
  const [hyderabadOpacity, setHyderabadOpacity] = reactExports.useState(0);
  const [hyderabadY, setHyderabadY] = reactExports.useState(20);
  const [avatarOpacity, setAvatarOpacity] = reactExports.useState(0);
  const [nameOpacity, setNameOpacity] = reactExports.useState(0);
  const [flashOpacity, setFlashOpacity] = reactExports.useState(0);
  const [showRipples, setShowRipples] = reactExports.useState(false);
  const [exitAnim, setExitAnim] = reactExports.useState(false);
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        style: {
          ...
          animation: exitAnim ? "zoomFade 0.5s ease-in forwards" : void 0
        },
        children: [
          ...
          phase === "ride" && /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "svg",
                {
                  ...
                  children: [
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "30", cy: "60", r: "4", fill: "white" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "circle",
                      {
                        cx: "130",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("circle", { cx: "130", cy: "60", r: "4", fill: "white" }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "line",
                      {
                        x1: "30",
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("ellipse", { cx: "85", cy: "10", rx: "7", ry: "7", fill: "white" }),
                    " ",
                    /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "line",
                      {
                    ...
                    /* @__PURE__ */ jsxRuntimeExports.jsx("defs", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs("linearGradient", { id: "trailGrad", x1: "0", y1: "0", x2: "1", y2: "0", children: [
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "0%", stopColor: "#7c3aed", stopOpacity: "0" }),
                      /* @__PURE__ */ jsxRuntimeExports.jsx("stop", { offset: "40%", stopColor: "#06b6d4", stopOpacity: "0.6" }),
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
                inset: 0,
                backgroundImage: "url('/assets/uploads/Screenshot-2026-03-21-200837-1.png')",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              style: {
                position: "absolute",
                inset: 0,
                background: "linear-gradient(to bottom, rgba(88,28,135,0.6), rgba(15,10,30,0.8))",
                opacity: charminarOpacity,
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    ...
                    textShadow: "0 0 30px rgba(124,58,237,0.9), 0 0 60px rgba(124,58,237,0.5), 0 0 90px rgba(6,182,212,0.3)"
                  },
                  children: "HYDERABAD"
                }
              )
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    ...
                    children: [
                      ...
                      /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            ...
                            filter: phase === "snap" || phase === "exit" ? "brightness(1.8) drop-shadow(0 0 24px #7c3aed)" : "drop-shadow(0 0 24px #7c3aed)",
                          ...
                          children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                            "div",
                            {
                              style: {
                                ...
                                alignItems: "center",
                                justifyContent: "center",
                                background: "linear-gradient(135deg, oklch(0.72 0.28 285), oklch(0.62 0.28 315))",
                                color: "white",
                                fontWeight: "bold",
                                fontSize: "2.5rem"
                              },
                      ...
                      showRipples && [0, 1, 2].map((i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
                        "div",
                        {
                          style: {
                            position: "absolute",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsxs(
                  "div",
                  {
                    style: {
                      textAlign: "center",
                      opacity: nameOpacity,
                      transform: nameOpacity === 1 ? "translateY(0)" : "translateY(12px)",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "button",
            {
              ...
              onMouseLeave: (e) => {
                e.currentTarget.style.background = "rgba(15,10,30,0.75)";
...
function LoadingOverlay({ onComplete }) {
  ...
  const [overlayExit, setOverlayExit] = reactExports.useState(false);
  reactExports.useEffect(() => {
    let timer;
    if (phase === "in") {
  ...
  const textTransform = phase === "in" ? "translateY(0)" : phase === "out" ? "translateY(-20px)" : "translateY(0)";
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "div",
    {
      ...
      style: {
        ...
        alignItems: "center",
        justifyContent: "center",
        background: "radial-gradient(ellipse at 50% 0%, #0d1f3c 0%, #060d1f 40%, #020810 100%)",
        opacity: overlayExit ? 0 : 1,
        transition: "opacity 600ms ease",
        pointerEvents: overlayExit ? "none" : "all"
      },
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "loading-orbs", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "orb orb-1" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "orb orb-2" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "orb orb-3" })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(
                "span",
                {
                  style: {
                    ...
                    textShadow: "0 0 40px rgba(139,92,246,0.8), 0 0 80px rgba(99,102,241,0.5), 0 0 120px rgba(59,130,246,0.3)",
                    lineHeight: 1.1,
                    fontFamily: isTelugu || isDevanagari ? "'Noto Sans', 'Noto Sans Telugu', 'Noto Sans Devanagari', system-ui, sans-serif" : "'Playfair Display', Georgia, serif"
                  },
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            children: GREETINGS.map((g, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
              "span",
              {
                style: {
                  ...
                  height: "0.4rem",
                  borderRadius: "9999px",
                  background: i <= step ? "linear-gradient(90deg, #6366f1, #8b5cf6)" : "rgba(255,255,255,0.2)",
...
const PROJECTS = [
  {
    title: "Pathwiz",
    description: "An intelligent interview preparation platform designed to help aspiring developers and students practice coding challenges, mock interviews, and technical assessments with personalized feedback.",
...
const HACKATHONS = [
  {
    ...
    description: "An interactive and innovative experience where we explored unique ideas that truly expanded our thinking at NRCM College.",
    image: "https://pub-1407f82391df4ab1951418d04be76914.r2.dev/uploads/caf6aab2-249d-42f5-ae08-b581aa8667f4.jpg",
    link: "https://drive.google.com/file/d/1LW7JvV7BmbCf1RpHKAUgANxl7ipf22GA/view"
  },
  {
    name: "Hackforge 2026 (48hrs)",
    description: "A dynamic hackathon experience focused on creativity and problem-solving, where innovative ideas came to life at CMRIT College.",
    image: "https://media.licdn.com/dms/image/v2/D4D22AQF7sUWTCrQSdg/feedshare-shrink_2048_1536/B4DZzYctVjJQAg-/0/1773157932158?e=1775692800&v=beta&t=PkP_sYMuAI4pcAITHorMLAF9X7EP13Yy6sRsxcBy8JA",
...
const CERTIFICATIONS = [
  {
    name: "Basic Python",
    description: "Completed a foundational course in Python, covering core programming concepts and problem-solving techniques.",
    image: "https://s3.amazonaws.com/coursera_assets/meta_images/generated/CERTIFICATE_LANDING_PAGE/CERTIFICATE_LANDING_PAGE~9F2S3619YEL6/CERTIFICATE_LANDING_PAGE~9F2S3619YEL6.jpeg"
  },
  {
    name: "AI Tools Workshop",
    description: "Participated in a hands-on workshop exploring modern AI tools and real-world applications.",
    image: "https://media.licdn.com/dms/image/v2/D5622AQGmpI0Lv8Y5kA/feedshare-shrink_800/B56Zv0giHuH4Ag-/0/1769333727956?e=1775692800&v=beta&t=hl52HzX8EpRczbcF8uWSbZ4yeGfjikkZmX0C72cHDuo"
  }
];
const PARTICLES = [
...
function useTypewriter(text, typeSpeed = 60, deleteSpeed = 40, pauseAfterType = 2e3, pauseAfterDelete = 500) {
...
function Navbar({
  ...
  const handleNav = reactExports.useCallback((href) => {
    setOpen(false);
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 ${scrolled ? "bg-background/80 backdrop-blur-xl border-b border-border shadow-glow-sm" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "button",
            {
              type: "button",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "font-display font-bold text-sm grad-text hidden sm:block", children: "Shrutisree" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden md:flex items-center gap-0.5", children: NAV_LINKS.map((link) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `px-2 py-1.5 rounded-md text-xs font-medium transition-all duration-200 ${isActive ? "bg-primary/20 text-primary nav-link-active" : "text-muted-foreground hover:text-foreground hover:bg-accent"}`,
                "data-ocid": "nav.link",
                children: [
                  link.label,
                  isActive && /* @__PURE__ */ jsxRuntimeExports.jsx(
                    "span",
                    {
                      ...
                      style: {
                        background: "linear-gradient(to right, oklch(0.72 0.28 285), oklch(0.62 0.28 315))",
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "md:hidden bg-background/95 backdrop-blur-xl border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "max-w-7xl mx-auto px-4 py-4 space-y-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => handleNav(link.href),
...
function TypewriterSubtitle({ dark }) {
  ...
  const displayed = useTypewriter(text, 60, 40, 2e3, 500);
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "span",
    {
      style: dark ? {
        background: "linear-gradient(90deg, oklch(0.82 0.28 285), oklch(0.72 0.28 315), oklch(0.65 0.25 230))",
        WebkitBackgroundClip: "text",
        WebkitTextFillColor: "transparent",
        backgroundClip: "text"
      } : {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "span",
          {
            style: {
              ...
              WebkitTextFillColor: dark ? "oklch(0.72 0.28 285)" : "oklch(0.42 0.25 285)",
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: dark ? "radial-gradient(ellipse at 50% 40%, #0d1f3c 0%, #060d1f 45%, #020810 100%)" : "radial-gradient(ellipse at 50% 40%, oklch(0.97 0.01 280) 0%, oklch(0.94 0.015 270) 50%, oklch(0.96 0.008 290) 100%)"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 -z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.72 0.28 285 / 0.8), oklch(0.62 0.28 315 / 0.4))"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.55 0.25 230 / 0.5), oklch(0.45 0.22 210 / 0.2))",
                animationDelay: "2s"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.55 0.25 230 / 0.5), transparent)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.72 0.28 285 / 0.15), transparent 70%)"
              }
            }
          )
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              backgroundImage: "linear-gradient(oklch(0.72 0.28 285) 1px, transparent 1px), linear-gradient(90deg, oklch(0.72 0.28 285) 1px, transparent 1px)",
              backgroundSize: "60px 60px"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "absolute inset-0 -z-10 pointer-events-none", children: PARTICLES.map((p) => /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-5xl mx-auto px-4 sm:px-6 text-center", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "linear-gradient(135deg, oklch(0.72 0.28 285 / 0.5), oklch(0.62 0.28 315 / 0.3), oklch(0.55 0.25 230 / 0.2))",
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      background: "conic-gradient(from 0deg, oklch(0.72 0.28 285), oklch(0.55 0.25 230), oklch(0.62 0.28 315), oklch(0.72 0.28 285))",
                      padding: "2px"
                    }
                  }
                ),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                    ...
                    style: {
                      boxShadow: "0 0 0 3px oklch(0.72 0.28 285 / 0.6), 0 0 40px oklch(0.72 0.28 285 / 0.35), 0 0 80px oklch(0.62 0.28 315 / 0.2)"
                    },
                    children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                      "div",
                      {
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              style: {
                ...
                opacity: 0,
                background: dark ? "oklch(0.72 0.28 285 / 0.1)" : "oklch(0.92 0.04 280)",
                border: dark ? "1px solid oklch(0.72 0.28 285 / 0.35)" : "1px solid oklch(0.52 0.22 285 / 0.5)",
              ...
              children: [
                ...
                /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium text-primary tracking-wide", children: "Welcome to my portfolio" })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "h1",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "grad-text glow-text name-shimmer", children: "Shrutisree Tadepalli" })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              children: /* @__PURE__ */ jsxRuntimeExports.jsx(TypewriterSubtitle, { dark })
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground leading-relaxed", children: "I'm passionate about understanding how machines think and building intelligent solutions." }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-base sm:text-lg text-muted-foreground leading-relaxed", children: "Currently learning Python and exploring real-world applications of AI." })
              ]
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsxs(
              ...
              children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "span",
                  {
                    ...
                    style: {
                      background: dark ? "oklch(0.22 0.05 280 / 0.6)" : "oklch(0.92 0.04 280)",
                      borderColor: dark ? "oklch(0.72 0.28 285 / 0.25)" : "oklch(0.52 0.22 285 / 0.6)",
                      color: dark ? "oklch(0.75 0.15 280)" : "oklch(0.32 0.18 280)"
                    },
                    children: "AI and ML Enthusiast"
                  }
                ),
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute bottom-8 left-1/2 -translate-x-1/2 flex flex-col items-center gap-1 animate-float opacity-60", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xs text-muted-foreground", children: "scroll" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-px h-8 bg-gradient-to-b from-primary/60 to-transparent" })
        ] })
      ]
    }
  );
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(User, { className: "w-5 h-5" }), label: "About Me" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "grid lg:grid-cols-5 gap-16 items-center mt-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:col-span-2 flex justify-center reveal", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            className: "w-64 h-64 sm:w-72 sm:h-72 rounded-3xl grad-border overflow-hidden",
            style: {
              boxShadow: "0 0 40px oklch(0.72 0.28 285 / 0.2), 0 0 80px oklch(0.62 0.28 315 / 0.1)"
            },
            children: /* @__PURE__ */ jsxRuntimeExports.jsx(
              "div",
              {
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "lg:col-span-3 space-y-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-lg leading-relaxed text-muted-foreground reveal reveal-delay-1", children: [
          "Hey! I'm",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-foreground font-semibold", children: "Shruti" }),
          " — a 1st-year Computer Science student at",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: "CMR Institute of Technology, Hyderabad" }),
          ". I'm an aspiring Full Stack Developer with a growing interest in",
          " ",
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-primary font-medium", children: "AI & ML" }),
          "."
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg leading-relaxed text-muted-foreground reveal reveal-delay-2", children: "I'm focused on building strong fundamentals in programming and software development while actively working on projects to apply what I learn." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-lg leading-relaxed text-muted-foreground reveal reveal-delay-2", children: "I enjoy exploring new technologies, solving problems, and continuously improving my skills as a developer." }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "pt-4 reveal reveal-delay-3", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "inline-flex items-center gap-3 px-4 py-3 rounded-xl bg-card border border-border hover:border-primary/40 transition-colors", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-xl", children: "🌏" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-sm font-medium", children: "Intern @ Evolve x" })
        ] }) })
      ] })
    ] })
  ] }) });
...
function Education() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "education", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "hidden md:block relative", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsx(
          "div",
          {
            ...
            style: {
              background: "linear-gradient(to bottom, oklch(0.72 0.28 285), oklch(0.62 0.28 315), oklch(0.55 0.25 230))"
            }
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-12", children: EDUCATION.map((edu, i) => {
          const isLeft = i % 2 === 0;
          return /* @__PURE__ */ jsxRuntimeExports.jsxs(
            "div",
            {
              ...
              children: [
                isLeft ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-end", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EducationCard, { edu, align: "right" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", {}),
                /* @__PURE__ */ jsxRuntimeExports.jsx(
                  "div",
                  {
                ...
                !isLeft ? /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex justify-start", children: /* @__PURE__ */ jsxRuntimeExports.jsx(EducationCard, { edu, align: "left" }) }) : /* @__PURE__ */ jsxRuntimeExports.jsx("div", {})
              ]
            },
            edu.institution
          );
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "md:hidden relative", children: [
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-10", children: EDUCATION.map((edu, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            ...
            children: [
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsx(EducationCard, { edu, align: "left" })
            ]
          },
          edu.institution
        )) })
...
function EducationCard({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx(
    Card,
    {
      className: `grad-border bg-card hover:shadow-glow-lg hover:scale-[1.02] transition-all duration-300 w-full max-w-sm ${align === "right" ? "text-right" : "text-left"}`,
      children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "div",
          {
            className: `flex flex-wrap items-start justify-between gap-3 mb-2 ${align === "right" ? "flex-row-reverse" : ""}`,
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "div",
                {
                  ...
                  children: [
                    /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: edu.icon }),
                    /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-sm text-foreground leading-tight", children: edu.degree })
                  ]
                }
              ),
              /* @__PURE__ */ jsxRuntimeExports.jsx(
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground font-medium text-sm mb-2", children: edu.institution }),
        /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "bg-primary/20 text-primary border border-primary/30 hover:bg-primary/30 text-xs", children: edu.grade })
      ] })
    }
  );
}
function Skills() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "skills", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Layers, { className: "w-5 h-5" }), label: "Skills" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid sm:grid-cols-2 gap-6 max-w-2xl", children: SKILLS.map((group, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-3 mb-5", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("span", { className: "text-2xl", children: group.icon }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-semibold text-base text-foreground", children: group.category })
          ] }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-2", children: group.items.map((skill) => /* @__PURE__ */ jsxRuntimeExports.jsx(
            Badge,
            {
              variant: "secondary",
...
function Experience() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "experience", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 relative", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx(
        "div",
        {
          ...
          style: {
            background: "linear-gradient(to bottom, oklch(0.72 0.28 285), oklch(0.55 0.25 230), transparent)"
          }
        }
      ),
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-10", children: EXPERIENCE.map((exp, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
          ...
          children: [
            ...
            /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "grad-border bg-card hover:shadow-glow-lg hover:scale-[1.02] transition-all duration-300", children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-7", children: [
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-wrap items-start justify-between gap-3 mb-4", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
                  /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-lg text-foreground", children: exp.role }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-primary font-semibold", children: exp.company }),
                  /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground", children: exp.location })
                ] }),
                /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-end gap-2", children: [
                  ...
                  /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs", children: exp.type })
                ] })
              ] }),
              /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "space-y-2", children: exp.bullets.map((b) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
                "li",
                {
...
function Projects() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "projects", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(CodeXml, { className: "w-5 h-5" }), label: "Projects" }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid sm:grid-cols-2 lg:grid-cols-3 gap-6", children: PROJECTS.map((project, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      Card,
      {
        className: `reveal reveal-delay-${i % 3 + 1} grad-border bg-card hover:shadow-glow-lg hover:scale-[1.02] transition-all duration-300 group flex flex-col ${project.featured ? "ring-1 ring-primary/30" : ""}`,
        "data-ocid": `projects.item.${i + 1}`,
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6 flex flex-col flex-1", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-start justify-between gap-3 mb-3", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground group-hover:text-primary transition-colors", children: project.title }),
          ...
          project.featured && /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { className: "w-fit mb-3 bg-primary/20 text-primary border border-primary/30 text-xs", children: "⭐ Featured" }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed flex-1 mb-4", children: project.description }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "flex flex-wrap gap-1.5 mb-4", children: project.tech.map((t) => /* @__PURE__ */ jsxRuntimeExports.jsx(Badge, { variant: "secondary", className: "text-xs px-2", children: t }, t)) }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex gap-3 mt-auto", children: [
            project.github && project.github !== "#" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: project.github,
                target: "_blank",
                ...
                onMouseEnter: (e) => {
                  e.currentTarget.style.boxShadow = "0 0 12px 2px oklch(0.72 0.28 285 / 0.5)";
                  e.currentTarget.style.transform = "scale(1.05)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.boxShadow = "0 0 0 0 oklch(0.72 0.28 285 / 0)";
            ...
            project.live && project.live !== "#" && /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "a",
              {
                href: project.live,
                target: "_blank",
                ...
                onMouseEnter: (e) => {
                  e.currentTarget.style.boxShadow = "0 0 16px 3px oklch(0.72 0.28 285 / 0.6)";
                  e.currentTarget.style.transform = "scale(1.05)";
                },
                onMouseLeave: (e) => {
                  e.currentTarget.style.boxShadow = "0 0 0 0 oklch(0.72 0.28 285 / 0)";
...
function Hackathons() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "hackathons", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid sm:grid-cols-2 gap-6", children: HACKATHONS.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsx(
      "a",
      {
        href: h.link,
        target: "_blank",
        ...
        children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
          Card,
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-48 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
                "img",
                {
                  src: h.image,
                  alt: h.name,
              ...
              /* @__PURE__ */ jsxRuntimeExports.jsxs(CardContent, { className: "p-6", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-base text-foreground mb-2", children: h.name }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm text-muted-foreground leading-relaxed", children: h.description })
              ] })
            ]
          }
        )
...
function Certifications() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "certifications", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(
      SectionHeading,
      {
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid sm:grid-cols-2 gap-5 max-w-2xl", children: CERTIFICATIONS.map((cert, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "a",
      {
        href: cert.image,
        target: "_blank",
        ...
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "w-full h-40 overflow-hidden", children: /* @__PURE__ */ jsxRuntimeExports.jsx(
            "img",
            {
              src: cert.image,
              referrerPolicy: "no-referrer",
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "p-4", children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-semibold text-sm text-foreground leading-tight mb-1", children: cert.name }),
            /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground leading-relaxed", children: cert.description })
          ] })
        ]
      },
      cert.name
...
function Contact() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsx(SectionHeading, { icon: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-5 h-5" }), label: "Contact" }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 flex flex-col items-center text-center reveal", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-3xl text-foreground mb-12", children: "Get in Touch" }),
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col sm:flex-row gap-6", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-xl bg-primary/10 text-primary group-hover:bg-primary/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Mail, { className: "w-6 h-6" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "Email" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "shrutisreetadepalli@gmail.com" })
              ] })
            ]
          }
        ),
        /* @__PURE__ */ jsxRuntimeExports.jsxs(
          "a",
          {
            ...
            className: "flex items-center gap-4 p-5 rounded-2xl border border-border bg-card hover:border-primary/40 hover:bg-primary/5 hover:scale-[1.04] hover:shadow-[0_0_24px_6px_rgba(139,92,246,0.5)] transition-all duration-200 group min-w-[220px]",
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-3 rounded-xl bg-primary/10 text-primary group-hover:bg-primary/20 transition-colors", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Linkedin, { className: "w-6 h-6" }) }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "text-left", children: [
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-xs text-muted-foreground", children: "LinkedIn" }),
                /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-sm font-medium text-foreground", children: "Connect with me" })
              ] })
            ]
          }
        )
...
function SectionHeading({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex flex-col items-start gap-3 reveal", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "flex items-center gap-2.5", children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("h2", { className: "font-display font-bold text-3xl sm:text-4xl text-gray-900 dark:text-white heading-glow", children: label })
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "heading-underline" })
  ] });
}
function Footer() {
  const year = (/* @__PURE__ */ new Date()).getFullYear();
  return /* @__PURE__ */ jsxRuntimeExports.jsx("footer", { className: "border-t border-border py-8", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6 flex flex-col sm:flex-row items-center justify-between gap-4", children: [
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "© ",
      year,
      " Shrutisree. All rights reserved."
    ] }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs("p", { className: "text-sm text-muted-foreground", children: [
      "Built with ❤️ using",
      " ",
...
function App() {
  ...
  const [introComplete, setIntroComplete] = reactExports.useState(false);
  ...
  const toggleDark = reactExports.useCallback(() => setDark((d) => !d), []);
  useScrollReveal();
  if (!introComplete) {
    return /* @__PURE__ */ jsxRuntimeExports.jsx(CinematicIntro, { onComplete: handleIntroComplete });
  }
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(jsxRuntimeExports.Fragment, { children: [
    !loaded && /* @__PURE__ */ jsxRuntimeExports.jsx(LoadingOverlay, { onComplete: () => setLoaded(true) }),
    /* @__PURE__ */ jsxRuntimeExports.jsxs(
      "div",
      {
        className: "min-h-screen bg-background",
        style: {
          background: dark ? "radial-gradient(ellipse at 50% 0%, #0d1f3c 0%, #060d1f 40%, #020810 100%)" : void 0,
          opacity: loaded ? 1 : 0,
          transition: "opacity 600ms ease"
        },
        children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(Navbar, { dark, toggleDark }),
          /* @__PURE__ */ jsxRuntimeExports.jsxs("main", { children: [
            /* @__PURE__ */ jsxRuntimeExports.jsx(Hero, { dark }),
