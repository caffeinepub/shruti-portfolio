...
function Navbar({
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsxs(
    "header",
    {
      className: `fixed top-0 left-0 right-0 z-50 transition-all duration-300 overflow-hidden ${scrolled ? "bg-background/80 backdrop-blur-xl border-b border-border shadow-glow-sm" : "bg-transparent"}`,
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 pointer-events-none -z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.72 0.28 285 / 0.45), transparent 70%)"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.62 0.28 315 / 0.4), transparent 70%)",
                animationDelay: "3s"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.55 0.25 230 / 0.35), transparent 70%)",
                animationDelay: "6s"
              }
            }
          )
...
function Hero({ dark }) {
  ...
  reactExports.useEffect(() => {
    ...
    const spawnStar = () => {
      ...
      const x = edge === "top" ? Math.random() * canvas.width : Math.random() * canvas.width * 0.3;
      const y = edge === "top" ? Math.random() * canvas.height * 0.3 : Math.random() * canvas.height;
        ...
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "absolute inset-0 -z-10", children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.72 0.28 285 / 0.35), oklch(0.62 0.28 315 / 0.15))"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.55 0.25 230 / 0.3), oklch(0.45 0.22 210 / 0.1))",
                animationDelay: "4s"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.62 0.28 315 / 0.28), oklch(0.72 0.28 285 / 0.1))",
                animationDelay: "8s"
              }
            }
          ),
          /* @__PURE__ */ jsxRuntimeExports.jsx(
            "div",
            {
              ...
              style: {
                background: "radial-gradient(circle, oklch(0.55 0.25 230 / 0.25), transparent 70%)",
                animationDelay: "12s"
              }
            }
          )
...
function About() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "about", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-3xl mx-auto space-y-6", children: [
