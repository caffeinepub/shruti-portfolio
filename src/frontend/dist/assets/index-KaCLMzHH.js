    ...
    "header",
    {
      ...
      children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("nav", { className: "max-w-7xl mx-auto px-4 sm:px-6 h-16 flex items-center justify-between", children: [
          ...
          /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "hidden lg:flex items-center gap-1", children: NAV_LINKS.slice(1).map((link) => {
            ...
            return /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsxs(
              "button",
              {
                ...
                className: `px-3 py-1.5 rounded-md text-sm font-medium transition-all duration-200 ${isActive ? "bg-primary/20 text-primary nav-link-active" : "text-muted-foreground hover:text-foreground hover:bg-accent"}`,
                "data-ocid": "nav.link",
                children: [
                  link.label,
        ...
        open && /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "lg:hidden bg-background/95 backdrop-blur-xl border-b border-border", children: /* @__PURE__ */ jsxRuntimeExports.jsx("ul", { className: "max-w-7xl mx-auto px-4 py-4 space-y-1", children: NAV_LINKS.map((link) => /* @__PURE__ */ jsxRuntimeExports.jsx("li", { children: /* @__PURE__ */ jsxRuntimeExports.jsx(
          "button",
          {
            type: "button",
            onClick: () => handleNav(link.href),
...
function Hackathons() {
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "hackathons", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "mt-16 grid sm:grid-cols-2 gap-6", children: HACKATHONS.map((h, i) => /* @__PURE__ */ jsxRuntimeExports.jsxs(
      Card,
      {
...
function Contact() {
  ...
  return /* @__PURE__ */ jsxRuntimeExports.jsx("section", { id: "contact", className: "py-24 sm:py-32", children: /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "max-w-7xl mx-auto px-4 sm:px-6", children: [
    ...
    /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "mt-16 grid lg:grid-cols-2 gap-16", children: [
      /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { className: "reveal space-y-8", children: [
        /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
          /* @__PURE__ */ jsxRuntimeExports.jsx("h3", { className: "font-display font-bold text-2xl text-foreground mb-4", children: "Let's build something great together." }),
          /* @__PURE__ */ jsxRuntimeExports.jsx("p", { className: "text-muted-foreground leading-relaxed", children: "Whether it's a job opportunity, collaboration on an exciting project, or just a chat about technology — my inbox is always open. I'll try to respond within 24 hours." })
        ] }),
        /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "space-y-4", children: [
          ...
          "a",
          {
            ...
            children: [
              /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "p-2.5 rounded-lg bg-primary/10 text-primary group-hover:bg-primary/20 transition-colors", children: item.icon }),
              /* @__PURE__ */ jsxRuntimeExports.jsxs("div", { children: [
      ...
      /* @__PURE__ */ jsxRuntimeExports.jsx("div", { className: "reveal reveal-delay-2", children: /* @__PURE__ */ jsxRuntimeExports.jsx(Card, { className: "grad-border bg-card", children: /* @__PURE__ */ jsxRuntimeExports.jsx(CardContent, { className: "p-8", children: sent ? /* @__PURE__ */ jsxRuntimeExports.jsxs(
        "div",
        {
